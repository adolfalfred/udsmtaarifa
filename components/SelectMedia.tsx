...
export default function SelectMedia({ media, setMedia }: { media: string[]; setMedia: (setImageId: string[]) => void }) {
    ...
    return (
        <>
            <TouchableOpacity className="my-3 flex-row gap-1 flex-wrap items-center py-5 px-4 border border-foreground-light/60 border-dashed dark:border-foreground-dark/60 rounded-xl" onPress={presentModal}>
